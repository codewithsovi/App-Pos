                ...
                <div class="modal-body">
                    ...
                    <div class="form-group my-1">
                        ...
                        <input type="number" name="harga_beli_pokok" id="harga_beli_pokok" class="form-control"
                            value="{{ old('harga_beli_pokok', $produk->harga_beli_pokok) }}">
                    </div>
                    <div class="form-group my-1">
                    ...
                    <div class="form-group my-1">
                        ...
                        <input type="number" name="stock_min" id="stock_min" class="form-control"
                            value="{{ old('stock_min', $produk->stock_min) }}">
                    </div>
                    <div class="form-group my-1 d-flex flex-column">
                        <div class="d-flex align-items-center">
                            <label for="is_active" class="mr-3">Produk Aktif?</label>
                            <pre>
    old: {{ var_dump(old('is_active')) }}
    produk: {{ var_dump($produk->is_active ?? null) }}
</pre>
                            <input type="hidden" name="is_active" value="0">
                            <input type="checkbox" name="is_active" value="1" id="is_active"
                                @checked(old('is_active', $produk->is_active ?? 0))>
                            {{-- <input type="checkbox" name="is_active" id="is_active"
                                value="{{ old('stock', $produk->is_active) }}"> --}}
                        </div>
